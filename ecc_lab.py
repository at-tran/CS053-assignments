...
from vec import Vec
from mat import Mat
from bitutil import bits2mat, str2bits, noise, bits2str, mat2bits
from GF2 import one
...
def find_error(syndrome):
    ...
    Examples:
        ...
        True
    """
    for c, v in mat2coldict(H).items():
        if v == syndrome:
            return Vec(set(range(7)), {c: one})
...
def find_error_matrix(S):
    ...
    Example:
        ...
        True
    """
    return coldict2mat({c: find_error(s) for c, s in mat2coldict(S).items()})
